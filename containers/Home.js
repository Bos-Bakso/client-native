...
import { View, Text, StyleSheet, SafeAreaView, TextInput, TouchableOpacity, Image, Animated, Easing, ImageBackground } from 'react-native'
...
export default function Home(props) {
  ...
  useEffect(() => {
    if (first) {
      ...
      setInterval(function () { _getLocationAsync() }, 3000)
    }
  }, [])
      ...
      <View style={{ ...styleg.safearea }}>
        <View style={{ height: 25 }}>
          <View style={{ flexDirection: 'row', justifyContent: 'center', alignItems: 'center' }}>
            ...
            <Text style={{ fontWeight: 'bolder', fontSize: 25, color: 'white' }}>5 </Text>
        ...
        <View style={{ width: "95%", justifyContent: 'center', alignItems: 'center', marginTop: 18 , backgroundColor: 'grey', alignSelf: 'center'}}>
          <View style={{ width: '100%', borderRadius: 12, backgroundColor: '#F2F3F4', alignItems: 'center' , flexDirection: 'row', padding: 10}}>
            ...
            <Image source={yellow} style={{ width: 87, height: 87, resizeMode: 'containt', borderRadius: 87 / 2, margin: 5 }} />
            </View>
